    ...
    <>
      <Container className="home">
        <Card className="text-center">
          ...
          <Card.Body>
            <Card.Title>Welcome to The Book Den</Card.Title>
            <Card.Text>
              Where you can find your favorite books, add to a wishlist, and
              interact with other users' book choices!
            </Card.Text>
            {!auth.loggedIn() && (
                    ...
                    <Col key={book._id}>
                      <Card border="dark">
                        ...
                        <Card.Body>
                          ...
                          <br />
                          <Card.Text>
                            To read or leave comments on this review, click the
                            title of the book above.
                          </Card.Text>
                        </Card.Body>
                      </Card>
                      <br />
